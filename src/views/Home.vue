...
export default {
  ...
  metaInfo () {
    ...
    return {
      ...
      script: [
        { innerHTML: `function utmx_section(){}function utmx(){}(function(){var
          k='146067935-7',d=document,l=d.location,c=d.cookie;
          ...
          <\/script><script>utmx('url','A/B');`, type: 'text/javascript' },
      ]
    }
  },
  beforeMount() {
