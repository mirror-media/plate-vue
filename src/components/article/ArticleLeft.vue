<template>
  <section class="list-container">
    ...
    <router-link :to="getHref(article[10])" class="list-wide"><div class="list-wide__img" :style="{ backgroundImage: 'url(' + getImage(article[10], 'desktop') + ')' }">
    ...
    <div class="list-narrow">
      <router-link :to="getHref(article[11])"><div>
      ...
      <router-link :to="getHref(article[12])"><div>
        <div class="list-narrow__img"
    ...
    <div class="list-narrow">
      <router-link :to="getHref(article[13])"><div>
        <div class="list-narrow__img"
      ...
      <router-link :to="getHref(article[14])"><div>
        <div class="list-narrow__img"
