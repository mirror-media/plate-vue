<template>
  <div class="share" :class="direction"
    ...
    <a id="share-google" class="share__icon share__icon--list share--google" :class="[isOpen ? 'open' : '']" @click="shareGooglePlus"><img src="/assets/mirrormedia/icon/google-plus.png" alt="Google Plus"></a>
  </div>
</template>
